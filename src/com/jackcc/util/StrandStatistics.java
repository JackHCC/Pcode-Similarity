...
public class StrandStatistics {
    ...
    public static HashMap<String, Integer> getCountOfLibStrand(ArrayList<byte []> libStrands) {
        if (libStrands == null || libStrands.size() == 0) return null;
    ...
    public static HashMap<String, BigInteger> getProbabilityReverseOfLibStrand(HashMap countStrandMap, BigInteger libSize){
