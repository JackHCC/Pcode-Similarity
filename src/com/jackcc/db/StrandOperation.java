...
public class StrandOperation {
	...
	public void add(HashMap countStrandMap, HashMap probabilityReverseMap)
		...
		ArrayList<BigInteger> probabilityReverseList =
				typeBigint.hashMapValue2list(probabilityReverseMap);

		String sql =
				"INSERT INTO strand_statistic ('strand', 'count', 'probability_reverse') VALUES (?, ?, ?)";
